...
// Индексы lanes нужны: внутри циклов мы и читаем, и мутируем `lanes[i]` (снять
// lane после мержа/прохода), и сравниваем номера колонок i/col между собой —
// итераторный вариант ломает borrow и теряет смысл алгоритма колонок.
