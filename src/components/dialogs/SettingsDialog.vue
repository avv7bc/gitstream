...
const timeoutOptions = [5, 10, 15, 20, 25, 30, 60];
...
const themes = computed(() => [
  ...
  { value: "materiallight" as const, label: i18n.value.settings.themeMaterialLight },
  ...
  { value: "latte" as const, label: i18n.value.settings.themeLatte },
  { value: "solarized" as const, label: i18n.value.settings.themeSolarized },
  { value: "githublight" as const, label: i18n.value.settings.themeGithubLight },
